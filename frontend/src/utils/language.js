...
const TRANSLATIONS = {
  en: {
    ...
    homeSubtitle: "Track, analyze, and manage your Movement Network assets in real time. Monitor DeFi positions, token balances, and earn social reputation all in one place.",
