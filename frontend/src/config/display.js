...
export const TOKEN_VISUALS = {
  ...
  BTC: { logo: "/BTC.png", color: { primary: "#f7931a", secondary: "#ffb84d" } },
  ...
  SOLVBTC: { logo: "/SolvBTC.webp", color: { primary: "#f7931a", secondary: "#ffc107" } },
  USDE: { logo: "/USDe.webp", color: { primary: "#171717", secondary: "#3d3d3d" } },
  USDA: { logo: "/USDa.webp", color: { primary: "#2196f3", secondary: "#64b5f6" } },
  WEETH: { logo: "/weETH.webp", color: { primary: "#7c3aed", secondary: "#a78bfa" } },
};
