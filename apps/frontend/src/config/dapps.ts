import { CANOPY_CONFIG, YUZU_CONFIG } from "./network";
import { DEFI_PROTOCOLS } from "./protocols";
...
export const TRACKED_DAPPS = [
  ...
  createDapp({
    ...
    keywords: [
      ...
      "unlock_with_coin",
      "withdraw_with_coin",
      "reactivate_stake_with_coin",
    ],
    modulePrefixes: ["0x1::delegation_pool::", "0x1::staking_contract::"],
  }),
  createDapp({
    key: "layerbank",
